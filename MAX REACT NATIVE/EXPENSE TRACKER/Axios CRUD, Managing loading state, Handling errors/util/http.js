...
const BACKEND_URL =
  'https://react-native-http-45253-default-rtdb.firebaseio.com';
// Axios CRUD step 1 post
export async function storeExpense(expenseData) {
  const response = await axios.post('https://react-native-http-45253-default-rtdb.firebaseio.com/expenses.json', expenseData);
...
export async function fetchExpenses() {
  const response = await axios.get('https://react-native-http-45253-default-rtdb.firebaseio.com/expenses.json');
